...
app.factory('Cates', function() {
  ...
  var cates = [{
    id: 0,
	class: 'item-1',
	img: 'img/category/1/balcone_mini.jpg',
    name: 'DAL BANCONE',
    lastText: 'Salumi e formaggi dalla migliore tradizione emiliana.'
  }, {
    id: 1,
	class: 'item-2',
	img: 'img/category/1/pasta_mini.jpg',
    name: 'PASTA FRESCA',
    lastText: 'Farina e uova da galline allevate a terra.'
  }, {
    id: 2,
	class: 'item-3',
	img: 'img/category/1/fassona_mini.jpg',
    name: 'FASSONA PIEMONTESE',
    lastText: 'In questo locale si servono carni pregiate di Fassona piemontese della macelleria Oberto.'
  }, {
    id: 3,
	class: 'item-4',
	img: 'img/category/1/carne_mini.jpg',
    name: 'CARNE ALLA GRIGLIA',
    lastText: 'Griglia a pietra lavica. Il sapore vero della carne.'
  }, {
    id: 4,
	class: 'item-5',
	img: 'img/category/1/hamburger1_mini.jpg',
    name: 'HAMBURGER',
    lastText: 'Carne di fassone piemontese, panino fresco tutti i giorni, salse fatte in casa e verdura fresca.'
  }, {
    id: 5,
  class: 'item-6',
  img: 'img/category/1/desserts_mini.jpg',
    name: 'DESSERTS',
    lastText: 'Dolci della tradizione e fantasie dello Chef.'
  }, {
    id: 6,
  class: 'item-7',
  img: 'img/category/1/vini_mini.jpg',
    name: 'VINI',
    lastText: 'Selezioniamo vini con pochi solfiti e da cantine che usano pochi concimi chimici in vigna.'
  }, {
    id: 7,
  class: 'item-8',
  img: 'img/category/1/birre_mini.jpg',
    name: 'LE BIRRE',
    lastText: 'Tante birre italiane con un occhio di riguardo per le artigianali.'
  }];
